function hvicodes=btc_hvi(codes,dict)
% hvicodes=btc_hvi(codes,dict) finds the axis corresponding to
% horizontal/vertical interchange of a code letter (northwest-southeast axis). The new string
...
%    BTC_HFLIP, BTC_VFLIP, BTC_HVIREV.
%
%stdtable='gbcdetuvwa';
fliptable='gcbdetwvua';
