...
%
%compare affine with direct pwaffine, but no cuts, should match
[ifok,matches]=psg_geomodels_apply_util(yvals,'affine','pwaffine_nocuts_direct','same',tol);
%
%compare affine with piecewise affine, should not match
[ifok,matches]=psg_geomodels_apply_util(yvals,'affine','pwaffine','diff',tol);
%
