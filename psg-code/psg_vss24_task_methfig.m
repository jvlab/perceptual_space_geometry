% psg_vss24_task_methfig: create a methods figure showing a dataset as a point set, and the distances
%
%  See also:  PSG_GET_COORDSETS, PSG_PLOTCOORDS, PSG_GEO_PROCRUSTES. 
opts_read=struct;
opts_rays=struct;
opts_qpred=struct;
