...
matches=double(diffs<=tol);
disp(sprintf('comparing %30s with %30s, s.b. %6s: %8s maxdiff=%15.8f, ndiff=%6.0f nsame=%6.0f',f1,f2,samediff,string_ans{ans_ind},max(diffs),sum(diffs>tol),sum(matches)));
return
